  ...
  return (
    <div id="install" data-section="install">
      <Section
        variant="accent"
        title="Install"
        description="One command to install. Prefix any CLI agent with greywall -- to run it inside the sandbox."
      >
        ...
        <div className="max-w-2xl">
          <p className="text-sm font-sans text-muted-foreground mb-2">Then run the agent inside the sandbox:</p>
